...
//
//
// $Id: Filter.java,v 1.8 2000/04/16 22:15:48 carzanig Exp $
//
package siena;
 ...
 *  elementary condition on a specific attribute of the event.  A
 *  <code>Filter</code> can have more that one constraint for an
 *  attribute.  For example, a </code>Filter<code> can express things
 *  like <em>[model="custom", price &gt; 10, price &lt;= 20]</em>.
 *  <p>
 *
...
public class Filter {
    ...
    */
	...
	addConstraint(s,new AttributeConstraint(AttributeConstraint.NE,lval));
    };
#else
    public void addConstraint(String s, long lval) {
