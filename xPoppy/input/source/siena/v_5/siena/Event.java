...
//
//
// $Id: Event.java,v 1.7 2000/04/17 17:11:50 carzanig Exp $
//
package siena;
 ...
 *  with a letter and may contain only An attribute name must contain
 ...
 *  slash character (<code>'/'</code>). Attribute names must be unique
 *  within an <code>Event</code>.
 *
 *  @see AttributeValue 
 *
 **/
