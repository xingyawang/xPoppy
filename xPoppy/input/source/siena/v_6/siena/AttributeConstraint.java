...
//
//
// $Id: AttributeConstraint.java,v 1.8 2000/05/09 17:09:11 carzanig Exp $
//
package siena;
...
/**
   an <code>AttributeConstraint</code> represents an elementary
...
public class AttributeConstraint {
    ...
    /** has prefix (for strings only, e.g., "software" PF "soft") */
    public static final short	PF		= 6;
    /** has suffix (for strings only, e.g., "software" SF "ware") */
    public static final short	SF		= 7;
    /** <em>any</em> */
    public static final short	XX		= 8;
    /** not equal  */
    public static final short	NE		= 9;
    /** contains substring (for strings only, e.g., "software" SS "war") */
