...
//
//
// $Id: SENP.java,v 1.10 2000/04/13 16:22:15 carzanig Exp $
//
package siena;
...
public class SENP {
	...
	if ((x >> 6) != 0) sb.append((byte)(x >> 6));
	if ((x >> 3) != 0) sb.append((byte)((x >> 6) & 7));
	sb.append((byte)(x & 7));
	return sb; 
    }
	...
	switch(t.nextToken()) {
#ifdef F_SP_HD_1
	case Tokenizer.T_ID: return new AttributeValue(t.ival);
#else
