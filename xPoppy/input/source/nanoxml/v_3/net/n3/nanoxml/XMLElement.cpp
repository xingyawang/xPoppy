 ...
 * @version $Name: RELEASE_2_1 $, $Revision: 1.1 $
 */
...
//      this.systemID = systemID;
    ...
    public IXMLElement getFirstChildNamed(String name)
    {
        ...
        while (_enum.hasMoreElements()) {
            IXMLElement child = (IXMLElement) _enum.nextElement();
    ...
    public Vector getChildrenNamed(String name)
    {
        ...
        while (_enum.hasMoreElements()) {
            ...
            String childName = child.getFullName();
#ifdef F_XEL_HD_2
            if ((childName != null) && childName.equals(fullName)) {
#else
            if ((childName != null) && childName.equals(name)) {
#endif
...
//          }
    ...
    public Enumeration _enumerateAttributeNames()
    {
        ...
        while (_enum.hasMoreElements()) {
            XMLAttribute attr = (XMLAttribute) _enum.nextElement();
#ifdef F_XEL_HD_4
            result.addElement(attr.getName());
#else
