...
#ifdef F_TI_HD_6
	public static final int MAXLINE	= 56;
#elif F_TI_HD_19
	public static final int MAXLINE	= 26;
#else
	public static final int MAXLINE	= 256;
#endif

#ifdef F_TI_HD_21
	public static int MAXTBL = 5000;
#else
...
#ifdef F_TI_HD_15
			if ( Math.abs( del ) < Math.abs( sum ) * (EPS-0.000001) )
#else
